...
- 배포본은 romfs 파일 23개를 덮어씌우는 LayeredFS 패치와, 일본판 CIA·3DS 파일을 한글판으로 바꾸는 패처 두 가지입니다. 둘 중 하나만 쓰면 됩니다.
...
게임 안 한글은 두 방법이 같습니다. [배포 페이지](../../releases/latest)에서 **둘 중 하나만** 골라 받으면 됩니다.
...
3. 3DS 실기에는 만든 CIA를 설치합니다. 이미 설치된 일본판에 덮어 설치해도 세이브는 유지됩니다. 3DS 파일은 복호화된 상태라 에뮬레이터·플래시카트용입니다.
