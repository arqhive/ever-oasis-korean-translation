...
- EverOasis_KO_v0.4_Patcher.zip (방법 B)
...
1. EverOasis_KO_v0.4_LayeredFS.zip 안의 luma 폴더를 SD 카드 루트에 그대로 복사합니다.
   다음과 같이 파일이 놓이면 됩니다.
...
2. EverOasis_KO_v0.4_Patcher.zip 을 폴더째 압축 풀고, 준비한 파일을 "패치하기.bat"에 끌어다 놓습니다.
